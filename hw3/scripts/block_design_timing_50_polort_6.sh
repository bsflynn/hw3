#!/bin/bash
	echo "" > results/block_design_timing_50_polort_6.txt
	...
	> results/block_design_timing_50_polort_6.txt
	echo "" >> results/block_design_timing_50_polort_6.txt
	scripts/efficiency_parser.py results/block_design_timing_50_polort_6.txt >> results/block_design_timing_50_polort_6.txt