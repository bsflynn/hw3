#!/bin/bash
	echo "" > results/block_design_timing_50_polort_12.txt
	...
	> results/block_design_timing_50_polort_12.txt
	echo "" >> results/block_design_timing_50_polort_12.txt
	scripts/efficiency_parser.py results/block_design_timing_50_polort_12.txt >> results/block_design_timing_50_polort_12.txt